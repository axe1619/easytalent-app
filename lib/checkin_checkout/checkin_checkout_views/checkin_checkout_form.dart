...
class _CheckInCheckOutFormPageState extends State<CheckInCheckOutFormPage> {
  ...
  void initState() {
    super.initState();
    fetchToken();
    swipeDirection = 'Desliza para Marcar Entrada';
    _initializeData();
    if (clockCheckedIn) {
      getCheckIn().then((_) {
        setState(() {
    ...
    if (clockIn != 'false') {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        setState(() {
          ...
          swipeDirection = 'Desliza para Marcar Salida';
        });
      });
    } else {
      isCheckIn = false;
  ...
  void showCheckInFailedDialog(BuildContext context, String errorMessage) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Error al Marcar Entrada'),
              ...
              child: Column(
                ...
                children: [
                  const Row(
                    ...
                    children: [
                      Text('Marcar Entrada', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Text('Marcado: Hoy a las ', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                          Text(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text('Marcar Salida', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
