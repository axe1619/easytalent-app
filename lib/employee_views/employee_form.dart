...
class _EmployeeFormPageState extends State<EmployeeFormPage>
  ...
  NotchBottomBarController _controller = NotchBottomBarController(index: 2);
  int maxCount = 5;
  int? employeeId;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText: "Relación del Contacto de Emergencia",
                                        labelStyle:
                                        TextStyle(color: Colors.grey[350]),
                                        border: const OutlineInputBorder(),
                                        contentPadding:
  ...
  void _showEditOptions(BuildContext context, employeeDetails, firstName,
    ...
    if (employeeDetails['id'] != null && employeeDetails['id'] != employeeId) {
      menuItems.insert(
          ...
          const PopupMenuItem(
            value: 'work',
            child: Text('Información Laboral'),
          ));
    }
                                ...
                                TabBar(
                                  ...
                                  tabs: [
                                    ...
                                    if (showWorkTypeAndShiftTab)
                                      const Tab(text: 'Tipo de Trabajo y Turno'),
                                  ],
                                ),
                                SizedBox(
                                  height:
          ...
          Theme(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                switch (index) {
                  case 0:
                    titleText = "Información Personal";
                  ...
                  case 1:
                    ...
                    break;
                  case 2:
                    titleText = "Información Bancaria";
                                      ...
                                      Expanded(
                                        child: Column(
                                          children: [
                                            ...
                                            TextField(
                                              decoration: const InputDecoration(
                                                labelText: 'Información de Turno',
                                                labelStyle: TextStyle(
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: 20,
                                                    color: Colors.black),
                ...
                children: [
                  const Expanded(
                    child: Padding(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                          labelText: 'Solicitud de Tipo de Trabajo',
                          labelStyle: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                          ),
                ...
                children: [
                  const Expanded(
                    child: Padding(
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                          labelText: 'Tipo de Trabajo Rotativo',
                          labelStyle: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                          ),
